...
public class WordLadder
{
    ...
    private static Ladder getShortestTransformationIterative( String startWord,
                                                              String endWord,
    ...
    private static Ladder getShortestTransformationRecursive( String startWord,
                                                              String endWord,
                                                              Set<String> dictionary )
    {
    ...
    private static void recursiveHelperShortest( String startWord,
                                                 String endWord,
                                                 Set<String> dictionary,
                                                 Ladder ladder,
                                                 LinkedList<Ladder> allPath,
                                                 Ladder shortestPath )
    {
        ...
        while( i.hasNext() )
        {
            ...
            if( differByOne( string, ladder.getLastWord() ) && !ladder.getPath().contains( string ) )
            {
                ...
                recursiveHelperShortest( startWord,
                                         endWord,
                                         dictionary,
                                         new Ladder( path, ladder.getLength() + 1, string ),
                                         allPath,
                                         shortestPath );
    ...
    private static boolean differByOne( String word1,
                                        String word2 )
    {
